...
function createProjectCard(project, index) {
    ...
    card.innerHTML = `
        ...
        <div class="project__content">
            <div class="project__title" ${project.galeria && project.galeria.length > 0 ? `onclick="abrirGaleria(${CONFIG.projects.indexOf(project)}, '${project.nombre.replace(/'/g, "\\'")}')"` : ''}>${project.nombre}</div>
